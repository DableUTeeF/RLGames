...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEditNumMCTSSims.setObjectName("lineEditNumMCTSSims")
        self.gridLayout.addWidget(self.lineEditNumMCTSSims, 4, 1, 1, 1)
        ...
        self.comboBoxWeightsName.addItem("")
        self.gridLayout.addWidget(self.comboBoxWeightsName, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButtonHintToggle, 6, 0, 1, 2)
        ...
        self.graphicsViewBoard.setGeometry(QtCore.QRect(12, 12, 500, 500))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "numMctsSims"))
        self.label.setText(_translate("MainWindow", "weights"))
        self.lineEditNumMCTSSims.setText(_translate("MainWindow", "25"))
        self.comboBoxWeightsName.setItemText(0, _translate("MainWindow", "1"))
        self.comboBoxWeightsName.setItemText(1, _translate("MainWindow", "2"))
